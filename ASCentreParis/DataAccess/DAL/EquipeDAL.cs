    ...
    public class EquipeDAL : IDisposable
    {
        ...
        public bool updateEquipe(Equipe objet)
        {
            ...
            try
            {
                ...
                requete = requete + " , CheminCalendrier = '" + objet.CheminCalendrier.Replace("'", "''") + "'";
                requete = requete + " , CheminFicheEntrainement = '" + objet.CheminFicheEntrainement.Replace("'", "''") + "'";
                requete = requete + " , CheminPhoto = '" + objet.CheminPhoto.Replace("'", "''") + "'";
